  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center animate-page-enter">
      ...
      <div className="relative mb-12">
        <div className="absolute inset-0 blur-3xl bg-[#A8442A]/10 rounded-full animate-pulse" />
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="w-32 h-32 rounded-[40px] bg-slate-900 border border-white/10 flex items-center justify-center shadow-2xl rotate-12 hover:rotate-0 transition-transform duration-500 group">
             <Compass size={64} className="text-[#A8442A] animate-spin-slow" />
          </div>
        </div>
      </div>
      ...
      <div className="text-center space-y-4 max-w-lg px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-8">
           <Link 
             to="/" 
             className="flex items-center justify-center gap-2 py-4 px-8 rounded-2xl bg-[#A8442A] text-slate-900 font-black uppercase text-xs tracking-widest shadow-xl shadow-[#A8442A]/20 hover:scale-105 transition-all"
           >
        ...
        <div className="pt-12 flex items-center justify-center gap-8 border-t border-white/5 mt-12">
           <div className="text-center group cursor-pointer">
              <Globe size={20} className="mx-auto text-slate-600 group-hover:text-[#A8442A] mb-2 transition-colors" />
           ...
           <div className="text-center group cursor-pointer">
              <MessageSquare size={20} className="mx-auto text-slate-600 group-hover:text-[#A8442A] mb-2 transition-colors" />
           ...
           <div className="text-center group cursor-pointer" onClick={() => window.history.back()}>
              <ArrowLeft size={20} className="mx-auto text-slate-600 group-hover:text-[#A8442A] mb-2 transition-colors" />
      ...
      <div className="fixed bottom-10 left-10 flex gap-4 pointer-events-none opacity-20">
         <div className="w-1 h-12 bg-[#A8442A] rounded-full" />
